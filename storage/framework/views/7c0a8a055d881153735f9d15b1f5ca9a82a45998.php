                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="form">
                            ...
                            <div class="col-lg-9">
                                <select name="wuliu_gongsi" class="form-control">
                                    <?php $__currentLoopData = $wuliu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <option value="<?php echo e($k->id); ?>" <?php if($wuliu_info->wuliu_gongsi == $k->id): ?> selected <?php endif; ?>><?php echo e($k->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-lg-2 control-label">请填写运单号</label>
                            <div class="col-lg-9">
                                <input class="form-control" name="wuliu_num" value="<?php echo e(old('wuliu_num', $wuliu_info->wuliu_num)); ?>">
                            </div>
                        </div>
...
<script>
    function fahuo(id) {
        ...
        $.ajax({
            type: "post",
            data: data,
            url: '<?php echo e(url('admin/edit_wuliu')); ?>/'+id,
            beforeSend: function () {
                layer.load(0);
            },
