            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form" action="<?php echo e(url('admin/permission')); ?>" method="post">
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">权限节点</label>
                                <div class="col-lg-9"><input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control"><span>* 必须为 xxx.xxx 格式</span>
                                </div>
                            </div>
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">权限介绍</label>
                                <div class="col-lg-9"><input type="text" name="description"  value="<?php echo e(old('description')); ?>" class="form-control">
                                </div>
                            </div>
