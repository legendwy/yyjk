...
<?php $__env->startSection('title', '编辑文章分类'); ?>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form" action="<?php echo e(url('admin/article_category/'.$category['id'].'')); ?>" method="post">
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">分类名称</label>
                                <div class="col-lg-9"><input type="text" name="name" value="<?php echo e($category['name']); ?>" class="form-control">
                                </div>
                            </div>
