    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('admin/ad/ad/'.$position_id )); ?>">广告列表</a>
                </li>
                <li class="active">
                    <strong>添加图片</strong>
                </li>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form" action="<?php echo e(url('admin/guang')); ?>" method="post" enctype="multipart/form-data">
