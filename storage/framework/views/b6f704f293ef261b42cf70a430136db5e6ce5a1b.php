    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('admin/role')); ?>">角色列表</a>
                </li>
                <li class="active">
                    <strong>添加角色</strong>
                </li>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form" action="<?php echo e(url('admin/role')); ?>" method="post">
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">角色</label>
                                <div class="col-lg-9"><input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control">
                                </div>
                            </div>
                            <?php echo csrf_field(); ?>

                            <div class="form-group"><label class="col-lg-2 control-label">角色名称</label>
                                <div class="col-lg-9"><input type="text" name="display_name"  value="<?php echo e(old('display_name')); ?>" class="form-control">
                                </div>
                            </div>
                                        ...
                                        <dd style="display: block">
                                            <dl class="cl permission-list2">
                                                <dt style="display: block; float: left; width: 160px">
                                                    <label class=""><input type="checkbox" id="<?php echo e($key); ?>"> &nbsp;<?php echo e($key); ?> <br/>(<?php echo e(permission_config($key)); ?>)</label>
                                                </dt>
                                                <dd style="display: block; float: left;">
                                                    <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_key => $_item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        <label style="width: 120px" class="">
                                                            <input type="checkbox" value="<?php echo e($_item['id']); ?>" name="permission[]" id="<?php echo e($key); ?>-<?php echo e($_item['id']); ?>">
