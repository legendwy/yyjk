...
<?php $__env->startSection('title', '添加图片'); ?>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo e(url('admin/image')); ?>">欢迎图</a>
                </li>
                <li class="active">
                    <strong>修改图片</strong>
                </li>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form" action="<?php echo e(url('admin/image/'.$image['id'])); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">尺寸</label>
                                <div class="col-lg-9"><input type="text" name="size" class="form-control" value="<?php echo e($image['size']); ?>">
                                </div>
                            </div>
