...
<?php $__env->startSection('title', '编辑退款退货理由'); ?>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form" action="<?php echo e(url('admin/reason/'.$info['id'].'')); ?>" method="post">
                            ...
                            <p class="font-bold  alert alert-warning m-b-sm" style="display: none" id="error"> </p>
                                <div class="form-group"><label class="col-lg-2 control-label">退款退货理由</label>
                                    <div class="col-lg-9"><input type="text" name="title" value="<?php echo e(old('title', $info['title'])); ?>" class="form-control">
                                    </div>
                                </div>
                                <?php echo csrf_field(); ?>
