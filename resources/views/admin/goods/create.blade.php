                ...
                <div class="ibox-content">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            {{--<li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">物流配送信息</a></li>--}}
                        </ul>
                        <form class="form form-horizontal" id="form" method="post" action="{{ url('admin/goods') }}" enctype="multipart/form-data">
                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ old('name') }}" placeholder="商品名称" id="name" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">商品描述：</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="describe" id="describe" placeholder="选填..">{{ old('describe') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="category_id" id="category_id" class="form-control">
                                                ...
                                                @foreach($category as $v)
                                                    <option value="{{ $v['id'] }}" @if(old('category_id', 0) == $v['id']) selected @endif>┠ {{ $v['category_name'] }}</option>
                                                    @if(!empty($v['child']))
                                                        @foreach($v['child'] as $_v)
                                                            <option value="{{ $_v['id'] }}" @if(old('category_id', 0) == $_v['id']) selected @endif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $_v['category_name'] }}</option>
                                                            {{--@if(!empty($_v['child']))--}}
                                                                {{--@foreach($_v['child'] as $__v)--}}
                                                                    {{--<option value="{{ $__v['id'] }}" @if(old('category_id', 0) == $__v['id']) selected @endif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $__v['category_name'] }}</option>--}}
                                                                {{--@endforeach--}}
                                                            {{--@endif--}}
                                                        @endforeach
                                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2 send">
                                            <img id="preview" src="{{ old('thumb', asset('img/img-bg.jpg')) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label>
                                                <input name="hot" type="radio" id="pay-3" value="1" @if(old('hot', -1) == 1) checked @endif>
                                                是
                                            </label> &nbsp;
                                            <label>
                                                <input name="hot" type="radio" id="pay-4" value="-1" @if(old('hot', -1) == -1) checked @endif>
                                                否
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label>
                                                <input name="tui" type="radio" id="pay-3" value="1" @if(old('tui', -1) == 1) checked @endif>
                                                是
                                            </label> &nbsp;
                                            <label>
                                                <input name="tui" type="radio" id="pay-4" value="-1" @if(old('tui', -1) == -1) checked @endif>
                                                否
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label>
                                                <input name="xian" type="radio" id="pay-3" value="1" @if(old('xian', -1) == 1) checked @endif>
                                                是
                                            </label> &nbsp;
                                            <label>
                                                <input name="xian" type="radio" id="pay-4" value="-1" @if(old('xian', -1) == -1) checked @endif>
                                                否
                                            </label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" placeholder="开始时间" class="form-control" name="date_star" id="date_star"  value="{{ old('date_star') }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group date">
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    <input type="text" placeholder="结束时间" class="form-control " value="{{ old('date_end') }}" name="date_end" id="date_end">
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <label>
                                                <input name="status" type="radio" id="pay-3" value="1" @if(old('status', 1) == 1) checked @endif>
                                             上架
                                            </label> &nbsp;
                                            <label>
                                                <input name="status" type="radio" id="pay-4" value="-1" @if(old('status', 1) == -1) checked @endif>
                                            下架
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" class="form-control"  placeholder="填写数字,排序越大,排名越靠前" id="sort" value="{{ old('sort', 0) }}" name="sort">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"  placeholder="邮费" id="postage" value="{{ old('postage', 0) }}" name="postage">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <div class="page-container">
                                        ...
                                        <input type="hidden" id="pic" name="pic" value="{{ old('pic') }}"/>
